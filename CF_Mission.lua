...
function SEF_VictoryAchieved()	
	...
	trigger.action.outText("Operation Clear Field Escalation - Mission Will Restart In 1 Minute", 60)
end
...
function SEF_MissionSelector()	
	...
	if ( NumberOfCompletedMissions >= TotalScenarios ) then
		...
		trigger.action.outText("Operation Clear Field Escalation - Operation Has Been Successful - Annihilation Victory Achieved", 60)
		SEF_VictoryAchieved()		
	else
...
function SEF_InitializeMissionTable()
	...
	OperationClearFieldMkII_AG[196] = {				
		TargetName = "Tkvarcheli - Supply Truck",
		TargetStatic = false,
		TargetBriefing = "Mission Update \nPrimary Objective - Destroy The Supply Trucks Located At Tkvarcheli\nTkvarcheli Sector - Grid GH14",
	}
	OperationClearFieldMkII_AG[197] = {				
		TargetName = "Gali - Convoy",
		TargetStatic = false,
		TargetBriefing = "Mission Update \nPrimary Objective - Destroy The Armored Vehicle Column Located At Gali\nGali Sector - Grid GH22",
	}
	OperationClearFieldMkII_AG[198] = {				
		TargetName = "Tskhinvali - Convoy",
		TargetStatic = false,
		TargetBriefing = "Mission Update \nPrimary Objective - Destroy The Armored Vehicle Column Located At Tskhinvali\nTskhinvali Sector - Grid MM17",
	}
...
function SEF_RadioMenuSetup()
	...
	SupportMenuAbort 	= missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "ABORT SUPPORT", SupportMenuMain)
	...
	Objective_Options_menu = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "Objective Options", nil)
	...
	SupportMenuCAP_KOB_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuCAP_KOB)
	SupportMenuCAP_KOB_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian And South Ossetian Sectors", SupportMenuCAP_KOB)
	SupportMenuCAP_KOB_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuCAP_KOB)
	SupportMenuCAP_KOB_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuCAP_KOB)
	
	SupportMenuCAP_TBL_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuCAP_TBL)
	SupportMenuCAP_TBL_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian And South Ossetian Sectors", SupportMenuCAP_TBL)
	SupportMenuCAP_TBL_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuCAP_TBL)
	SupportMenuCAP_TBL_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuCAP_TBL)
	
	--////DEPARTING KOBULETI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuCAP_KOB_Georgia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Tskhinvali") end, nil)
	
		--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuCAP_KOB_Abzkhazia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuCAP_KOB_Abzkhazia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuCAP_KOB_Abzkhazia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuCAP_KOB_Abzkhazia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuCAP_KOB_Abzkhazia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuCAP_KOB_Abzkhazia, function() SEF_USAEFCAPSPAWN("Kobuleti", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuCAP_KOB_Stav, function() SEF_USAEFCAPSPAWN("Kobuleti", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuCAP_KOB_Stav, function() SEF_USAEFCAPSPAWN("Kobuleti", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuCAP_KOB_Stav, function() SEF_USAEFCAPSPAWN("Kobuleti", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuCAP_KOB_Stav, function() SEF_USAEFCAPSPAWN("Kobuleti", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuCAP_KOB_Kras, function() SEF_USAEFCAPSPAWN("Kobuleti", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuCAP_KOB_Kras, function() SEF_USAEFCAPSPAWN("Kobuleti", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuCAP_KOB_Kras, function() SEF_USAEFCAPSPAWN("Kobuleti", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuCAP_KOB_Kras, function() SEF_USAEFCAPSPAWN("Kobuleti", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuCAP_KOB_Kras, function() SEF_USAEFCAPSPAWN("Kobuleti", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuCAP_KOB_Kras, function() SEF_USAEFCAPSPAWN("Kobuleti", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuCAP_KOB_Kras, function() SEF_USAEFCAPSPAWN("Kobuleti", "Sochi-Adler") end, nil)	
	
	--////DEPARTING TBILISI-LOCHINI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuCAP_TBL_Georgia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Tskhinvali") end, nil)
	
		--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuCAP_TBL_Abzkhazia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuCAP_TBL_Abzkhazia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuCAP_TBL_Abzkhazia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuCAP_TBL_Abzkhazia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuCAP_TBL_Abzkhazia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuCAP_TBL_Abzkhazia, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuCAP_TBL_Stav, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuCAP_TBL_Stav, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuCAP_TBL_Stav, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuCAP_TBL_Stav, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuCAP_TBL_Kras, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuCAP_TBL_Kras, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuCAP_TBL_Kras, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuCAP_TBL_Kras, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuCAP_TBL_Kras, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuCAP_TBL_Kras, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuCAP_TBL_Kras, function() SEF_USAEFCAPSPAWN("Tbilisi-Lochini", "Sochi-Adler") end, nil)
	...
	SupportMenuCAS_KOB_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuCAS_KOB)
	SupportMenuCAS_KOB_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuCAS_KOB)
	SupportMenuCAS_KOB_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuCAS_KOB)
	SupportMenuCAS_KOB_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuCAS_KOB)
	
	SupportMenuCAS_TBL_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuCAS_TBL)
	SupportMenuCAS_TBL_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuCAS_TBL)
	SupportMenuCAS_TBL_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuCAS_TBL)
	SupportMenuCAS_TBL_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuCAS_TBL)
	
	--////DEPARTING KOBULETI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuCAS_KOB_Georgia, function() SEF_USAEFCASSPAWN("Kobuleti", "Tskhinvali") end, nil)
	
		--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuCAS_KOB_Abzkhazia, function() SEF_USAEFCASSPAWN("Kobuleti", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuCAS_KOB_Abzkhazia, function() SEF_USAEFCASSPAWN("Kobuleti", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuCAS_KOB_Abzkhazia, function() SEF_USAEFCASSPAWN("Kobuleti", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuCAS_KOB_Abzkhazia, function() SEF_USAEFCASSPAWN("Kobuleti", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuCAS_KOB_Abzkhazia, function() SEF_USAEFCASSPAWN("Kobuleti", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuCAS_KOB_Abzkhazia, function() SEF_USAEFCASSPAWN("Kobuleti", "Zugdidi") end, nil)
	
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuCAS_KOB_Stav, function() SEF_USAEFCASSPAWN("Kobuleti", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuCAS_KOB_Stav, function() SEF_USAEFCASSPAWN("Kobuleti", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuCAS_KOB_Stav, function() SEF_USAEFCASSPAWN("Kobuleti", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuCAS_KOB_Stav, function() SEF_USAEFCASSPAWN("Kobuleti", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuCAS_KOB_Kras, function() SEF_USAEFCASSPAWN("Kobuleti", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuCAS_KOB_Kras, function() SEF_USAEFCASSPAWN("Kobuleti", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuCAS_KOB_Kras, function() SEF_USAEFCASSPAWN("Kobuleti", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuCAS_KOB_Kras, function() SEF_USAEFCASSPAWN("Kobuleti", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuCAS_KOB_Kras, function() SEF_USAEFCASSPAWN("Kobuleti", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuCAS_KOB_Kras, function() SEF_USAEFCASSPAWN("Kobuleti", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuCAS_KOB_Kras, function() SEF_USAEFCASSPAWN("Kobuleti", "Sochi-Adler") end, nil)	
	
	--////DEPARTING TBILISI-LOCHINI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuCAS_TBL_Georgia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Tskhinvali") end, nil)
	
	
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuCAS_TBL_Abzkhazia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuCAS_TBL_Abzkhazia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuCAS_TBL_Abzkhazia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuCAS_TBL_Abzkhazia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuCAS_TBL_Abzkhazia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuCAS_TBL_Abzkhazia, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuCAS_TBL_Stav, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuCAS_TBL_Stav, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuCAS_TBL_Stav, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuCAS_TBL_Stav, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuCAS_TBL_Kras, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuCAS_TBL_Kras, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuCAS_TBL_Kras, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuCAS_TBL_Kras, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuCAS_TBL_Kras, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuCAS_TBL_Kras, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuCAS_TBL_Kras, function() SEF_USAEFCASSPAWN("Tbilisi-Lochini", "Sochi-Adler") end, nil)
	...
	SupportMenuSEAD_KOB_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuSEAD_KOB)
	SupportMenuSEAD_KOB_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuSEAD_KOB)
	SupportMenuSEAD_KOB_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuSEAD_KOB)
	SupportMenuSEAD_KOB_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuSEAD_KOB)
	
	SupportMenuSEAD_TBL_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuSEAD_TBL)
	SupportMenuSEAD_TBL_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuSEAD_TBL)
	SupportMenuSEAD_TBL_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuSEAD_TBL)
	SupportMenuSEAD_TBL_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuSEAD_TBL)
	
	--////DEPARTING KOBULETI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuSEAD_KOB_Georgia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuSEAD_KOB_Abzkhazia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuSEAD_KOB_Abzkhazia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuSEAD_KOB_Abzkhazia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuSEAD_KOB_Abzkhazia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuSEAD_KOB_Abzkhazia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuSEAD_KOB_Abzkhazia, function() SEF_USAEFSEADSPAWN("Kobuleti", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuSEAD_KOB_Stav, function() SEF_USAEFSEADSPAWN("Kobuleti", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuSEAD_KOB_Stav, function() SEF_USAEFSEADSPAWN("Kobuleti", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuSEAD_KOB_Stav, function() SEF_USAEFSEADSPAWN("Kobuleti", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuSEAD_KOB_Stav, function() SEF_USAEFSEADSPAWN("Kobuleti", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuSEAD_KOB_Kras, function() SEF_USAEFSEADSPAWN("Kobuleti", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuSEAD_KOB_Kras, function() SEF_USAEFSEADSPAWN("Kobuleti", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuSEAD_KOB_Kras, function() SEF_USAEFSEADSPAWN("Kobuleti", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuSEAD_KOB_Kras, function() SEF_USAEFSEADSPAWN("Kobuleti", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuSEAD_KOB_Kras, function() SEF_USAEFSEADSPAWN("Kobuleti", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuSEAD_KOB_Kras, function() SEF_USAEFSEADSPAWN("Kobuleti", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuSEAD_KOB_Kras, function() SEF_USAEFSEADSPAWN("Kobuleti", "Sochi-Adler") end, nil)	
	
	--////DEPARTING TBILISI-LOCHINI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuSEAD_TBL_Georgia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuSEAD_TBL_Abzkhazia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuSEAD_TBL_Abzkhazia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuSEAD_TBL_Abzkhazia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuSEAD_TBL_Abzkhazia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuSEAD_TBL_Abzkhazia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuSEAD_TBL_Abzkhazia, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuSEAD_TBL_Stav, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuSEAD_TBL_Stav, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuSEAD_TBL_Stav, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuSEAD_TBL_Stav, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuSEAD_TBL_Kras, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuSEAD_TBL_Kras, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuSEAD_TBL_Kras, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuSEAD_TBL_Kras, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuSEAD_TBL_Kras, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuSEAD_TBL_Kras, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuSEAD_TBL_Kras, function() SEF_USAEFSEADSPAWN("Tbilisi-Lochini", "Sochi-Adler") end, nil)
	...
	SupportMenuPIN_KOB_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuPIN_KOB)
	SupportMenuPIN_KOB_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuPIN_KOB)
	SupportMenuPIN_KOB_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuPIN_KOB)
	SupportMenuPIN_KOB_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuPIN_KOB)
	
	SupportMenuPIN_TBL_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuPIN_TBL)
	SupportMenuPIN_TBL_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuPIN_TBL)
	SupportMenuPIN_TBL_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuPIN_TBL)
	SupportMenuPIN_TBL_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuPIN_TBL)
	
	--////DEPARTING KOBULETI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuPIN_KOB_Georgia, function() SEF_USAEFPINSPAWN("Kobuleti", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuPIN_KOB_Abzkhazia, function() SEF_USAEFPINSPAWN("Kobuleti", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuPIN_KOB_Abzkhazia, function() SEF_USAEFPINSPAWN("Kobuleti", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuPIN_KOB_Abzkhazia, function() SEF_USAEFPINSPAWN("Kobuleti", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuPIN_KOB_Abzkhazia, function() SEF_USAEFPINSPAWN("Kobuleti", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuPIN_KOB_Abzkhazia, function() SEF_USAEFPINSPAWN("Kobuleti", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuPIN_KOB_Abzkhazia, function() SEF_USAEFPINSPAWN("Kobuleti", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuPIN_KOB_Stav, function() SEF_USAEFPINSPAWN("Kobuleti", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuPIN_KOB_Stav, function() SEF_USAEFPINSPAWN("Kobuleti", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuPIN_KOB_Stav, function() SEF_USAEFPINSPAWN("Kobuleti", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuPIN_KOB_Stav, function() SEF_USAEFPINSPAWN("Kobuleti", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuPIN_KOB_Kras, function() SEF_USAEFPINSPAWN("Kobuleti", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuPIN_KOB_Kras, function() SEF_USAEFPINSPAWN("Kobuleti", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuPIN_KOB_Kras, function() SEF_USAEFPINSPAWN("Kobuleti", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuPIN_KOB_Kras, function() SEF_USAEFPINSPAWN("Kobuleti", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuPIN_KOB_Kras, function() SEF_USAEFPINSPAWN("Kobuleti", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuPIN_KOB_Kras, function() SEF_USAEFPINSPAWN("Kobuleti", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuPIN_KOB_Kras, function() SEF_USAEFPINSPAWN("Kobuleti", "Sochi-Adler") end, nil)	
	
	--////DEPARTING TBILISI-LOCHINI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuPIN_TBL_Georgia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuPIN_TBL_Abzkhazia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuPIN_TBL_Abzkhazia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuPIN_TBL_Abzkhazia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuPIN_TBL_Abzkhazia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuPIN_TBL_Abzkhazia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuPIN_TBL_Abzkhazia, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuPIN_TBL_Stav, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuPIN_TBL_Stav, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuPIN_TBL_Stav, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuPIN_TBL_Stav, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuPIN_TBL_Kras, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuPIN_TBL_Kras, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuPIN_TBL_Kras, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuPIN_TBL_Kras, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuPIN_TBL_Kras, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuPIN_TBL_Kras, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuPIN_TBL_Kras, function() SEF_USAEFPINSPAWN("Tbilisi-Lochini", "Sochi-Adler") end, nil)
	...
	SupportMenuASS_KOB_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuASS_KOB)
	SupportMenuASS_KOB_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuASS_KOB)
	SupportMenuASS_KOB_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuASS_KOB)
	SupportMenuASS_KOB_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuASS_KOB)
	
	SupportMenuASS_TBL_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuASS_TBL)
	SupportMenuASS_TBL_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuASS_TBL)
	SupportMenuASS_TBL_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuASS_TBL)
	SupportMenuASS_TBL_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuASS_TBL)
	
	--////DEPARTING KOBULETI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuASS_KOB_Georgia, function() SEF_USAEFASSSPAWN("Kobuleti", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuASS_KOB_Abzkhazia, function() SEF_USAEFASSSPAWN("Kobuleti", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuASS_KOB_Abzkhazia, function() SEF_USAEFASSSPAWN("Kobuleti", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuASS_KOB_Abzkhazia, function() SEF_USAEFASSSPAWN("Kobuleti", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuASS_KOB_Abzkhazia, function() SEF_USAEFASSSPAWN("Kobuleti", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuASS_KOB_Abzkhazia, function() SEF_USAEFASSSPAWN("Kobuleti", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuASS_KOB_Abzkhazia, function() SEF_USAEFASSSPAWN("Kobuleti", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuASS_KOB_Stav, function() SEF_USAEFASSSPAWN("Kobuleti", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuASS_KOB_Stav, function() SEF_USAEFASSSPAWN("Kobuleti", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuASS_KOB_Stav, function() SEF_USAEFASSSPAWN("Kobuleti", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuASS_KOB_Stav, function() SEF_USAEFASSSPAWN("Kobuleti", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuASS_KOB_Kras, function() SEF_USAEFASSSPAWN("Kobuleti", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuASS_KOB_Kras, function() SEF_USAEFASSSPAWN("Kobuleti", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuASS_KOB_Kras, function() SEF_USAEFASSSPAWN("Kobuleti", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuASS_KOB_Kras, function() SEF_USAEFASSSPAWN("Kobuleti", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuASS_KOB_Kras, function() SEF_USAEFASSSPAWN("Kobuleti", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuASS_KOB_Kras, function() SEF_USAEFASSSPAWN("Kobuleti", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuASS_KOB_Kras, function() SEF_USAEFASSSPAWN("Kobuleti", "Sochi-Adler") end, nil)	
	
	--////DEPARTING TBILISI-LOCHINI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuASS_TBL_Georgia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuASS_TBL_Abzkhazia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuASS_TBL_Abzkhazia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuASS_TBL_Abzkhazia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuASS_TBL_Abzkhazia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuASS_TBL_Abzkhazia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuASS_TBL_Abzkhazia, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuASS_TBL_Stav, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuASS_TBL_Stav, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuASS_TBL_Stav, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuASS_TBL_Stav, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuASS_TBL_Kras, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuASS_TBL_Kras, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuASS_TBL_Kras, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuASS_TBL_Kras, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuASS_TBL_Kras, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuASS_TBL_Kras, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuASS_TBL_Kras, function() SEF_USAEFASSSPAWN("Tbilisi-Lochini", "Sochi-Adler") end, nil)
	...
	SupportMenuDRONE_KOB_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuDRONE_KOB)
	SupportMenuDRONE_KOB_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuDRONE_KOB)
	SupportMenuDRONE_KOB_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuDRONE_KOB)
	SupportMenuDRONE_KOB_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuDRONE_KOB)
	
	SupportMenuDRONE_TBL_Georgia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P1 - Georgian Sectors", SupportMenuDRONE_TBL)
	SupportMenuDRONE_TBL_Abzkhazia = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P2 - Abzkhazian & Ossetian Sectors", SupportMenuDRONE_TBL)
	SupportMenuDRONE_TBL_Stav = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P3 - Stavropol Krai Sectors", SupportMenuDRONE_TBL)
	SupportMenuDRONE_TBL_Kras = missionCommands.addSubMenuForCoalition(coalition.side.BLUE, "P4 - Krasnodar Krai Sectors", SupportMenuDRONE_TBL)
	
	--////DEPARTING KOBULETI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuDRONE_KOB_Georgia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuDRONE_KOB_Abzkhazia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuDRONE_KOB_Abzkhazia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuDRONE_KOB_Abzkhazia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuDRONE_KOB_Abzkhazia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuDRONE_KOB_Abzkhazia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuDRONE_KOB_Abzkhazia, function() SEF_USAEFDRONESPAWN("Kobuleti", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuDRONE_KOB_Stav, function() SEF_USAEFDRONESPAWN("Kobuleti", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuDRONE_KOB_Stav, function() SEF_USAEFDRONESPAWN("Kobuleti", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuDRONE_KOB_Stav, function() SEF_USAEFDRONESPAWN("Kobuleti", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuDRONE_KOB_Stav, function() SEF_USAEFDRONESPAWN("Kobuleti", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuDRONE_KOB_Kras, function() SEF_USAEFDRONESPAWN("Kobuleti", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuDRONE_KOB_Kras, function() SEF_USAEFDRONESPAWN("Kobuleti", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuDRONE_KOB_Kras, function() SEF_USAEFDRONESPAWN("Kobuleti", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuDRONE_KOB_Kras, function() SEF_USAEFDRONESPAWN("Kobuleti", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuDRONE_KOB_Kras, function() SEF_USAEFDRONESPAWN("Kobuleti", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuDRONE_KOB_Kras, function() SEF_USAEFDRONESPAWN("Kobuleti", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuDRONE_KOB_Kras, function() SEF_USAEFDRONESPAWN("Kobuleti", "Sochi-Adler") end, nil)	
	
	--////DEPARTING TBILISI-LOCHINI
	
	--////GEORGIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG10 - Batumi", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Batumi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM24 - Gori", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Gori") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GG34 - Kobuleti", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Kobuleti") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM97 - Kutaisi", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Kutaisi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector KM58 - Senaki", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Senaki-Kolkhi") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Soganlug", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Soganlug") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM91 - Tbilisi", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Tbilisi-Lochini") end, nil)
	--missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector NM00 - Vaziani", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Vaziani") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MM17 - Tskhinvali", SupportMenuDRONE_TBL_Georgia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Tskhinvali") end, nil)
		
	--////ABZKHAZIA AND SOUTH OSSETIA
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH27 - Gudauta", SupportMenuDRONE_TBL_Abzkhazia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Gudauta") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH03 - Ochamchira", SupportMenuDRONE_TBL_Abzkhazia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Ochamchira") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector FH74 - Sukhumi", SupportMenuDRONE_TBL_Abzkhazia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Sukhumi-Babushara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH14 - Tkvarcheli", SupportMenuDRONE_TBL_Abzkhazia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Tkvarcheli") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH27 - Zemo-Azhara", SupportMenuDRONE_TBL_Abzkhazia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Zemo-Azhara") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector GH31 - Zugdidi", SupportMenuDRONE_TBL_Abzkhazia, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Zugdidi") end, nil)
		
	--////STAVROPOL KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MN68 - Beslan", SupportMenuDRONE_TBL_Stav, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Beslan") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP49 - Mineralnye-Vody", SupportMenuDRONE_TBL_Stav, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Mineralnye Vody") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector MP64 - Mozdok", SupportMenuDRONE_TBL_Stav, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Mozdok") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector LP81 - Nalchik", SupportMenuDRONE_TBL_Stav, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Nalchik") end, nil)	
	
	--////KRASNODAR KRAI
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK23 - Gelendzhik", SupportMenuDRONE_TBL_Kras, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Gelendzhik") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK99 - Krasnodar-Center", SupportMenuDRONE_TBL_Kras, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Krasnodar-Center") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK18 - Krasnodar-Pashkovsky", SupportMenuDRONE_TBL_Kras, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Krasnodar-Pashkovsky") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK27 - Krymsk", SupportMenuDRONE_TBL_Kras, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Krymsk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EK84 - Maykop", SupportMenuDRONE_TBL_Kras, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Maykop-Khanskaya") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector DK04 - Novorossiysk", SupportMenuDRONE_TBL_Kras, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Novorossiysk") end, nil)
	missionCommands.addCommandForCoalition(coalition.side.BLUE, "Sector EJ71 - Sochi-Adler", SupportMenuDRONE_TBL_Kras, function() SEF_USAEFDRONESPAWN("Tbilisi-Lochini", "Sochi-Adler") end, nil)	
end	
...
--[[
	...
	elseif (	Airbase.getByName(AIRBASE.Caucasus.Batumi):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Kobuleti):getCoalition() == 2 and			
				Airbase.getByName(AIRBASE.Caucasus.Senaki_Kolkhi):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Kutaisi):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Tbilisi_Lochini):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Vaziani):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Soganlug):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Sukhumi_Babushara):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Gudauta):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Nalchik):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Beslan):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Mozdok):getCoalition() == 2 and 
				Airbase.getByName(AIRBASE.Caucasus.Mineralnye_Vody):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Sochi_Adler):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Maykop_Khanskaya):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Krymsk):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Krasnodar_Pashkovsky):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Krasnodar_Center):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Novorossiysk):getCoalition() == 2 and
				Airbase.getByName(AIRBASE.Caucasus.Gelendzhik):getCoalition() == 2 ) then
				
				--Take And Hold Victory Achieved
				trigger.action.outText("Operation Clear Field Escalation - Operation Has Been Successful - Take And Hold Victory Achieved", 60)
...
function SEF_BattlePhaseCheckSilent()
	...
	elseif (	Airbase.getByName(AIRBASE.Caucasus.Batumi):getCoalition() == 2 and
				...
				--Then we have completed Phase 4
				return 5
...
--////MAIN
	...
	--SEF_TestMissionList()	
	timer.scheduleFunction(SEF_MissionSelector, nil, timer.getTime() + 17)
	SEF_RadioMenuSetup()
...
Ergneti - Armor					MM17
Ergneti - SA-18					MM17
Lazarevskoe - Cargo Ship		DJ18 West Of Lazarevskoe
Pitsunda - Cargo Ship			DJ91 West Of Pitsunda
Saberio - SA-8					GH42
Saberio - Armor					GH42
Saberio - AAA					GH42
