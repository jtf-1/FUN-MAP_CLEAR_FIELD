...
-- Author: Surrexen via Pikey's Simple Group Saving Script  à¼¼ ã�¤ â—•_â—• à¼½ã�¤    (ã�¥ï½¡â—•â€¿â—•ï½¡)ã�¥ 
--///////////////////////////////////////////////////////////////////////////////////
...
REDCAPTURETEAM 	= SPAWN:NewWithAlias("Vehicle Template", "Russian APC Tigr 233036"):InitRandomizeTemplate( { "Russian APC Tigr 233036" } )
