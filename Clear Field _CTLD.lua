...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 502, desc = "HMMWV - JTAC", unit = "Hummer", side = 2, }, --  used as jtac and unarmed, not on the crate list if JTAC is disabled
           ...
           if string.match(_name, "Gasoline") then
            ...
            elseif string.match(_name, "Net Cargo") then
              ...
              _crate = {
                      ...
                      ["shape_name"] = "ab-212_cargo", --new slingloadable container
                      ["type"] = "uh1h_cargo", --new type
                     -- ["unitId"] = _unitId,
                      ["y"] = _point.z,
                      ["x"] = _point.x,
                      ["mass"] = _weight,
